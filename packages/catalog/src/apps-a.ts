...
export const appsA: CatalogApp[] = [
  ...
  a({
    ...
    popularity: 95,
    updatedDaysAgo: 1,
    tags: ['chat', 'voz', 'comunidade', 'gaming', 'mensagens', 'conversa'],
    oss: ['windows', 'macos', 'linux'],
    archs: ['x64'],
  ...
  a({
    ...
    popularity: 90,
    updatedDaysAgo: 2,
    tags: ['mensageiro', 'meta', 'chat', 'zap', 'mensagens', 'whats'],
    oss: ['windows', 'macos'],
    archs: ['x64', 'arm64'],
  ...
  a({
    ...
    popularity: 83,
    updatedDaysAgo: 3,
    tags: ['videoconferência', 'reuniões', 'aulas', 'videochamada', 'reunião online'],
    oss: ['windows', 'macos'],
    archs: ['x64', 'arm64'],
  ...
  a({
    ...
    popularity: 93,
    updatedDaysAgo: 9,
    tags: ['player', 'vídeo', 'áudio', 'multimídia', 'filme', 'player de vídeo'],
    oss: ['windows', 'macos', 'linux'],
    archs: ['x64', 'arm64'],
    alternatives: [],
    packages: [
  ...
  a({
    ...
    popularity: 75,
    updatedDaysAgo: 20,
    tags: ['imagem', 'fotos', 'design', 'photoshop alternativa', 'edição de imagem'],
    oss: ['windows', 'macos', 'linux'],
    archs: ['x64'],
